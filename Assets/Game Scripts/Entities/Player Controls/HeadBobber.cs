...
{
    #region Variables
    private HeadBobberData m_data;

    private float m_xScroll;
    private float m_yScroll;

    private bool m_resetted;
    private Vector3 m_finalOffset;
    private float m_currentStateHeight = 0f;
    #endregion
    ...
    public HeadBobber(HeadBobberData _data, float _moveBackwardsMultiplier, float _moveSideMultiplier)
    {
        m_data = _data;
