...
public class PlayerCameraBreath : MonoBehaviour
{
    #region Variables
    [Space, Header("Data")]
    [SerializeField] private PerlinNoiseCamData data = null;
    ...
    private PerlinNoiseCamScroll m_perlinNoiseScroller;
    ...
    void Start()
    {
        m_perlinNoiseScroller = new PerlinNoiseCamScroll(data);
    }
