...
{    
    ...
    public class CameraZoom
    {
        ...
        public AnimationCurve ZoomCurve { get => zoomCurve; }
        public bool ZoomClicked { get => m_camInputData.ZoomClicked; }
        public bool IsZooming { get => m_camInputData.IsZooming; }
        ...
        public void ChangeFOV(MonoBehaviour _mono)
        {
            if(m_running)
            {
                m_camInputData.IsZooming = false;
        ...
        IEnumerator ChangeFOVRoutine()
        {
            ...
            float _targetFOV = m_camInputData.IsZooming ? zoomFOV : m_initFOV;
